module SpreeMigrateDB 
  module CanonicalSpree
    TABLES = {
      ...
      :prices                   => {:spree_1x => "spree_prices", :spree_0x                   => "prices"},
      ...
      :promotion_actions        => {:spree_1x => "spree_promotion_actions", :spree_0x        => "promotion_actions"},
      ...
      :promotions               => {:spree_1x => "spree_activators", :spree_0x               => "promotions"},
      ...
      :zip_code_ranges          => {:spree_1x => "spree_zip_code_ranges", :spree_0x          => "zip_code_ranges"},
